...
import fr.hetic.app_map_amis.adapter.GroupTripRecyclerAdapter
...
class GroupTripFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_grouptrip, container, false)
    ...
    private lateinit var contactAdapter: GroupTripRecyclerAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        contactAdapter = GroupTripRecyclerAdapter()
        addDataSet()
    }
