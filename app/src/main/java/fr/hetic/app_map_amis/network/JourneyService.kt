...
interface JourneyService {
    ...
    // %3B = ;
    @GET("coverage/fr-nw/journeys?from=2.3749036%3B48.8467927&to=2.2922926%3B48.8583736&")
    fun getJourney(@Header("Authorization") authorization:String): Call<JourneyResult>
